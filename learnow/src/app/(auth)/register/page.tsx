...
import { Mail, Lock, User, Terminal, Sparkles } from "lucide-react";
...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Supabase registration will hook here
    ...
    <div className="min-h-screen bg-background text-foreground flex items-stretch">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-20 relative z-10 bg-[#070709]">
        ...
        <div className="mx-auto w-full max-w-md">
          {/* Logo link */}
          <Link href="/" className="inline-flex items-center gap-2 group outline-none select-none mb-8">
          ...
          <p className="text-xs text-textSecondary mt-2 select-none">
            Rejoignez l'aventure LearnNow aujourd'hui. L'apprentissage gratuit est accessible à tous.
          </p>
          ...
          <p className="text-xs text-textSecondary text-center mt-8 select-none">
        ...
        <div className="max-w-md w-full px-8 relative z-10 flex flex-col items-center">
          ...
          <Card variant="elevated" padding="lg" className="w-full bg-[#101016]/80 text-left border-primary/20 glow-purple animate-pulse-glow select-none">
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge variant="green" outline className="text-[9px] uppercase tracking-widest font-black border-accent-green/30">
                <Sparkles className="h-3 w-3" /> Nouveau Profil
              </Badge>
            </div>
            
            <p className="font-mono text-xs text-accent-green leading-relaxed mb-4">
            ...
            <p className="font-mono text-[11px] text-textSecondary leading-relaxed">
              ...
              &nbsp;&nbsp;status: <span className="text-accent-green">"setup"</span>,<br />
              &nbsp;&nbsp;level: <span className="text-primary">1</span>,<br />
              &nbsp;&nbsp;title: <span className="text-accent-warning">"Curieux"</span>,<br />
              &nbsp;&nbsp;xp: <span className="text-primary">0</span>,<br />
              &nbsp;&nbsp;onboarding: <span className="text-accent-green">false</span><br />
              {"}"}
            </p>
          </Card>
          
          <h3 className="font-display font-extrabold text-xl text-center text-foreground mt-8 select-none">
            Une Progression 100% Assistée par IA 🤖
          </h3>
          <p className="text-xs text-textSecondary text-center leading-relaxed mt-2 max-w-xs select-none">
            Bénéficiez de recommandations de parcours adaptées à vos objectifs de carrière et de débogage pédagogique instantané.
          </p>
        </div>
      </div>
    </div>
